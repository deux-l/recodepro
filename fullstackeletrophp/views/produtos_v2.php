...
?>
            ...
            <img src="<?php echo $row["imagem"];?>" width='120' onMouseOver="zoomIn(this)" onMouseOut="zoomOut(this)">
            <br>
            <p><?php echo $row["descricao"];?></p>
            <hr>
            <font face="Arial" size="2"><strike>R$ <?php echo $row["preco"];?></strike></font><br>
            <font face="Arial" size="4" color="red">R$ <?php echo $row["precofinal"];?></font>
            </td>
